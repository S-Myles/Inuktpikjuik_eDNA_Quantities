...
common_samples <- Reduce(intersect, list(sample_ids12S, sample_ids16S, sample_ids18S))
...
merged_physeq <- merge_phyloseq(S12_physeq_pruned, S16_physeq_pruned, S18_physeq_pruned)
